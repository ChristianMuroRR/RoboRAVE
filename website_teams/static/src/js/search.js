odoo.define('website_teams.website_teams', function (require) {
'use strict';
...
//        'submit .js_wforum_submit_form:has(:not(.karma_required).o_wforum_submit_post)': '_onSubmitForm',
    ...
    start: function () {
        var self = this;
        console.log('start: function RR js')
        this.lastsearch = [];
        ...
        $('input.js_select2').select2({
            ...
            initSelection: function (element, callback) {
                console.log('initSelection RR js')
                var data = [];
